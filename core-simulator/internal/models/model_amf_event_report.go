...
type AmfEventReport struct {
	...
	LossOfConnectReason LossOfConnectivityReasonAnyOf `json:"lossOfConnectReason,omitempty"`
...
func (o *AmfEventReport) GetLossOfConnectReason() LossOfConnectivityReasonAnyOf {
...
func (o *AmfEventReport) SetLossOfConnectReason(v LossOfConnectivityReasonAnyOf) {

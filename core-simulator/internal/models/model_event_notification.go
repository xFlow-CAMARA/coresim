...
func (o EventNotification) MarshalJSON() ([]byte, error) {
	...
	if true {
		toSerialize["timeStamp"] = fmt.Sprintf("%d", o.TimeStamp.Unix()) // added timestamp as int64 (preferred)
	}
	if o.Supi != nil {
	...
	if o.CustomizedData != nil {
		toSerialize["customized_data"] = o.CustomizedData
	}
